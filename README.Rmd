...
p <- g %>%
  ...
  geom_abline(intercept = 0, slope = slope_mean, linetype = "dashed", size = rel(0.8),
    color = "#bb8888cc") +
  ...
  labs(x = "Days Since First Case",
    y = "Reported Cases",
    subtitle = "Individual and average state trajectories of reported cases of COVID-19 according to covidtracking.com",
